package com.ybcx.huluntears.scenes{
	...
	public class TentSubScene extends BaseScene{
		
		private var _tentBGPath:String = "assets/tent/tent_bg.jpg";
		//进入大地图场景箭头
		 ...
		 * ------------ 帐篷子场景 ----------
		 */ 
		public function TentSubScene(manager:ItemManager){
			super();
			_itemManager = manager;
		}
		
		override public function get itemsToPickup():Array{
			return ["dinggan_4","dinggan_5","dinggan_6","dinggan_7","tianchuang_2","weizhan"];
		}		
		
		
		override protected function initScene():void{
			addDownloadTask(_tentBGPath);
		...
		override protected function readyToShow():void{
			tentBg = this.getImageByUrl(_tentBGPath);
			this.addChild(tentBg);
